...
import { GET_PREDICTIONS } from '../../gql/queries';
...
export default function PredictionsPage() {
    ...
    return (
        <div id="predictions-page" className="flex flex-col w-full h-full shadow-md">
            <div className="card w-full h-full bg-base-100">

                <div role="tablist" className="tabs tabs-bordered mt-5">
                    <input type="radio" name="predictions_tabs" role="tab" className="tab text-xl" aria-label="Scatterplot" defaultChecked />
                    ...
                    <input type="radio" name="predictions_tabs" role="tab" className="tab text-xl" aria-label="Table" />
                    <div role="tabpanel" className="tab-content bg-base-100 border-base-100 rounded-box p-6 w-full h-full">
                        <div className="card-body">
                            <DataTable
                                data={data.predictions}
