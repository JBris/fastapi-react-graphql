DROP SEQUENCE IF EXISTS iris_id_seq;
CREATE SEQUENCE iris_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 START 150 CACHE 1;
...
CREATE TABLE "public"."iris" (
    ...
    "id" integer DEFAULT nextval('iris_id_seq') NOT NULL,
    CONSTRAINT "iris_pkey" PRIMARY KEY ("id")
) WITH (oids = false);

INSERT INTO "iris" ("sepal_length", "sepal_width", "petal_length", "petal_width", "species", "id") VALUES
